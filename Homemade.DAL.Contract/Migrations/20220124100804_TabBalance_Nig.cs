...
{
    public partial class TabBalance_Nig : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 10, new DateTime(2020, 9, 1, 12, 0, 0, 0, DateTimeKind.Unspecified), null, null, false, false, "شحن محفظة", "Charge Wallet", new Guid("52ca22a8-8d5e-4b96-b883-7d544219f216"), null, null, null, 1, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TabChargeExLog_CustomersID",
                schema: "Order",
                table: "TabChargeExLog",
                column: "CustomersID");

            migrationBuilder.CreateIndex(
                name: "IX_TabCharge_CustomerBalanceID",
                schema: "Order",
                table: "TabCharge",
                column: "CustomerBalanceID");

            migrationBuilder.CreateIndex(
                name: "IX_TabCharge_CustomersID",
                schema: "Order",
                table: "TabCharge",
                column: "CustomersID");

            migrationBuilder.AddForeignKey(
                name: "FK_TabCharge_CustomerBalance_CustomerBalanceID",
                schema: "Order",
                table: "TabCharge",
                column: "CustomerBalanceID",
                principalSchema: "Customer",
                principalTable: "CustomerBalance",
                principalColumn: "CustomerBlanceID",
                onDelete: ReferentialAction.Restrict);

            migrationBuilder.AddForeignKey(
                name: "FK_TabCharge_Customers_CustomersID",
                schema: "Order",
                table: "TabCharge",
                column: "CustomersID",
                principalSchema: "Customer",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_TabChargeExLog_Customers_CustomersID",
                schema: "Order",
                table: "TabChargeExLog",
                column: "CustomersID",
                principalSchema: "Customer",
