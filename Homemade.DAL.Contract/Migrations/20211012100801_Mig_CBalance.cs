...
{
    public partial class Mig_CBalance : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerBlanceID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomerBlanceGuid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerBalance", x => x.CustomerBlanceID);
                    table.ForeignKey(
                        name: "FK_CustomerBalance_Customers_CustomersID",
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerBalance_OrderVendor_OrderVendorID",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomerBalance_TransactionType_TransactionTypeID",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomerBalance_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VendorBlanceID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VendorBlanceGuid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TransactionTypeID = table.Column<int>(type: "int", nullable: false),
                    Before = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    After = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorBalance", x => x.VendorBlanceID);
                    table.ForeignKey(
                        name: "FK_VendorBalance_OrderVendor_OrderVendorID",
                        column: x => x.OrderVendorID,
                        principalSchema: "Order",
                        principalTable: "OrderVendor",
                        principalColumn: "OrderVendorID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VendorBalance_TransactionType_TransactionTypeID",
                        column: x => x.TransactionTypeID,
                        principalSchema: "Driver",
                        principalTable: "TransactionType",
                        principalColumn: "TransactionTypeID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VendorBalance_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VendorBalance_Vendors_VendorsID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderVendor_ShippingCompanyID",
                schema: "Order",
                table: "OrderVendor",
                column: "ShippingCompanyID");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerBalance_CustomersID",
                schema: "Customer",
                table: "CustomerBalance",
                column: "CustomersID");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerBalance_OrderVendorID",
                schema: "Customer",
                table: "CustomerBalance",
                column: "OrderVendorID");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerBalance_TransactionTypeID",
                schema: "Customer",
                table: "CustomerBalance",
                column: "TransactionTypeID");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerBalance_UserId",
                schema: "Customer",
                table: "CustomerBalance",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_VendorBalance_OrderVendorID",
                schema: "Vendor",
                table: "VendorBalance",
                column: "OrderVendorID");

            migrationBuilder.CreateIndex(
                name: "IX_VendorBalance_TransactionTypeID",
                schema: "Vendor",
                table: "VendorBalance",
                column: "TransactionTypeID");

            migrationBuilder.CreateIndex(
                name: "IX_VendorBalance_UserId",
                schema: "Vendor",
                table: "VendorBalance",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_VendorBalance_VendorsID",
                schema: "Vendor",
                table: "VendorBalance",
                column: "VendorsID");

            migrationBuilder.AddForeignKey(
                name: "FK_OrderVendor_ShippingCompany_ShippingCompanyID",
                schema: "Order",
                table: "OrderVendor",
                column: "ShippingCompanyID",
