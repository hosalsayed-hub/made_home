(function (b) {
    var a = {
        ...
        attach: function (e) {
            ...
            c.validateAttribute = d.find("[data-validation-engine*=validate]").length
            ...
            if (c.binded) {
                ...
                d.on(
                    c.validationEventTrigger,
                    "[" + c.validateAttribute + "*=validate][class*=datepicker]",
                    { delay: 300 },
                    a._onFieldEvent
                );
            }
        ...
        detach: function () {
            var d = this;
            var c = d.data("jqv");
            d.find("[" + c.validateAttribute + "*=validate]")
                .not("[type=checkbox]")
                .off(c.validationEventTrigger, a._onFieldEvent);
            d.find(
                "[" +
                c.validateAttribute +
                "*=validate][type=checkbox],[class*=validate][type=radio]"
            ).off("click", a._onFieldEvent);
        ...
        updatePromptsPosition: function (f) {
            ...
            var d = e.data("jqv");
            e.find("[" + d.validateAttribute + "*=validate]")
                .not(":disabled")
                .each(function () {
                    var i = b(this);
        ...
        _onSubmitEvent: function () {
            ...
            if (f.data("jqv_submitButton")) {
                ...
                if (d) {
                    if (d.length > 0) {
                        if (
                            d.hasClass("validate-skip") ||
                            d.attr("data-validation-engine-skip") == "true"
                        ) {
                            return true;
                        }
                    }
        ...
        _validateFields: function (e) {
            ...
            var n = null;
            e.find("[" + m.validateAttribute + "*=validate]")
                .not(":disabled")
                .each(function () {
                    var p = b(this);
                    var o = [];
                    if (b.inArray(p.attr("name"), o) < 0) {
                        ...
                        if (f && n == null) {
                            if (p.is(":hidden") && m.prettySelect) {
                                n = p = e.find(
                                    "#" + m.usePrefix + a._jqSelector(p.attr("id")) + m.useSuffix
                                );
                            } else {
                                n = p;
                            }
        ...
        _validateFormWithAjax: function (g, e) {
            ...
            var d = e.ajaxFormValidationURL
                ? e.ajaxFormValidationURL
                : g.attr("action");
        ...
        _validateField: function (d, l, s) {
            if (!d.attr("id")) {
                d.attr(
                    "id",
                    "form-validation-field-" + b.validationEngine.fieldIdCounter
                );
                ++b.validationEngine.fieldIdCounter;
            }
            if (
                !l.validateNonVisibleFields &&
                ((d.is(":hidden") && !l.prettySelect) || d.parent().is(":hidden"))
            ) {
                return false;
            }
            ...
            if (d.is(":hidden") && l.prettySelect) {
                d = e.find(
                    "#" + l.usePrefix + a._jqSelector(d.attr("id")) + l.useSuffix
                );
            }
        ...
        _getErrorMessage: function (c, n, l, p, g, q, m) {
            ...
            var d = l;
            var e = n.attr("data-validation-engine")
                ? n.attr("data-validation-engine")
                : n.attr("class");
            var h = e.split(" ");
            var k;
            if (
        ...
        _getCustomErrorMessage: function (j, e, h, l) {
            ...
            var c = "#" + j.attr("id");
            if (
                typeof l.custom_error_messages[c] != "undefined" &&
                ...
                if (e.length > 0) {
                    for (var g = 0; g < e.length && e.length > 0; g++) {
                        var k = "." + e[g];
                        if (
                            typeof l.custom_error_messages[k] != "undefined" &&
            ...
            switch (h.prop("type")) {
               ...
               /* case "file":*/
                ...
                case "checkbox":
                    ...
                    break;
                case "file":
                    if (((l = b.trim(h.val())), (e = b.trim(h.attr("data-validation-placeholder"))), (j = b.trim(h.attr("placeholder"))), !l || (e && l == e) || (j && l == j))) return m.allrules[k[f]].alertFile;
            }
        },
        _groupRequired: function (f, h, d, c) {
            var g = "[" + c.validateAttribute + "*=" + h[d + 1] + "]";
            var e = false;
            f.closest("form, .validationEngineContainer")
                .find(g)
                .each(function () {
        ...
        _dateRange: function (e, f, d, c) {
            ...
            if (
                !a._isDate(c.firstOfGroup[0].value) ||
        ...
        _dateTimeRange: function (e, f, d, c) {
            ...
            if (
                !a._isDateTime(c.firstOfGroup[0].value) ||
        ...
        _maxCheckbox: function (h, j, k, g, f) {
            ...
            if (c > d) {
                ...
                if (f.allrules.maxCheckbox.alertText2) {
                    return (
                        f.allrules.maxCheckbox.alertText +
                        " " +
                        d +
                        " " +
        ...
        _minCheckbox: function (h, j, k, g, f) {
            ...
            if (c < d) {
                f.showArrow = false;
                return (
                    f.allrules.minCheckbox.alertText +
                    " " +
                    d +
                    " " +
        ...
        _buildPrompt: function (i, c, g, k, m) {
            ...
            d.addClass(
                "parentForm" +
                a._getClassName(
                    i.closest("form, .validationEngineContainer").attr("id")
                )
            );
            ...
            if (m.showArrow) {
                ...
                switch (f) {
                    ...
                    case "bottomRight":
                        ...
                        j.addClass("formErrorArrowBottom").html(
                ...
                if (m.prettySelect) {
                    if (
                        ...
                        var e = b(
                            ...
                            i
                                .attr("id")
                                .substr(m.usePrefix.length)
                                .substring(m.useSuffix.length)
            ...
            if (f === "inline") {
                d.addClass("inline");
                if (
                    typeof i.attr("data-prompt-target") !== "undefined" &&
                    b("#" + i.attr("data-prompt-target")).length > 0
                ) {
        ...
        isRTL: function (e) {
            ...
            var d =
                (e && e.hasClass("rtl")) ||
                (e && (e.attr("dir") || "").toLowerCase() === "rtl") ||
                f.hasClass("rtl") ||
                (f.attr("dir") || "").toLowerCase() === "rtl" ||
                c.hasClass("rtl") ||
    ...
    b(function () {
        b.validationEngine.defaults.promptPosition = a.isRTL()
            ? "topLeft"
            : "topRight";
    });
})(jQuery);
