      ...
      a.validationEngineLanguage.allRules = {
        required: {
          regex: "none",
              ...
              alertTextCheckboxMultiple: "* برجاء الاختيار",
              alertTextCheckboxe: "* برجاء الاختيار",
              alertTextDateRange: "* Both date range fields are required",
              alertFile: "* برجاء ارفاق الملف",
        },
        requiredInFunction: {
        ...
        dateTimeRange: {
          ...
          minSize: { regex: "none", alertText: "* الحد الأدنى ", alertText2: " أحرف مطلوبة" },
          maxSize: { regex: "none", alertText: "* الحد الاقصى ", alertText2: " أحرف مطلوبة" },
        groupRequired: {
          regex: "none",
        ...
        email: {
          ...
          alertText: "* خطأ فى البريد الالكتروني",
          },
          arabicName: {
              regex: /^[\u0621-\u064A\u0660-\u0669\0-9]+$/,
              alertText: "* برجاء ادخال الحروف عربي",
          },
          englishName: {
              regex: /^[a-zA-Z\0-9]+$/,
              alertText: "* برجاء ادخال الحروف انجليزي",
          },
          file: {
              regex: /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,
                  alertText: "* يجب ارفاق صورة",
        },
        ...
        date: {
          func: function (h) {
            ...
            return (
              c.getFullYear() == e && c.getMonth() == g - 1 && c.getDate() == b
            );
          },
